  ...
  <!-- New driver modal -->
    <section class="content">
        ...
        <div class="card">
         ...
         <form action="/zonalAdmin/filterServiceDetails" method="POST">
            {{csrf_field()}}

          <div class="row">
              <input type="text" name="vName" value="{{$sd->vehicleNoService}}" hidden>
              <div class="col-12 col-lg-5">
          <h3 class="m-0 text-dark ml-3 mb-3"> Vehicle No : {{$sd->vehicleNoService}} </h3>
          </div>
      ...
      <div id="resReport">
<?php
$zone=App\vehicleDetail::where('regNo','=',$sd->vehicleNoService)->distinct('zone')->first();
?>
...
<div class="alert alert-light collapse" role="alert" style="text-align: center;" id="alert">
  ...
  <h6 style="color: black;">Vehicle No : {{$sd->vehicleNoService}} | {{$zone->zone}} | All Service Details<h6>
</div> 
    <table class="table table-striped table-bordered" id="vehicle">
      <thead>
        ...
        <tbody>
            @foreach(App\serviceDetail::where('vehicleNoService','=',$sd->vehicleNoService)->get(); as $sd)
