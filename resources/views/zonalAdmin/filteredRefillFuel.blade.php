  ...
  <!-- New driver modal -->
    <section class="content">
        ...
        <div class="alert collapse" role="alert" style="text-align: center; background-color: transparent;" id="alert1">
          <a href="/zonalAdmin/viewRefillDetails/{{$vNo}}" class="btn btn-success mb-3" id="back" style="width: 100px;">Back</a>
        </div>
        </div>
      </div>
        ...
        <div class="card">
         ...
         <form action="/zonalAdmin/filterFuelRefill" method="POST">
            {{csrf_field()}}
...
<div class="alert alert-light collapse" role="alert" style="text-align: center;" id="alert">
  <h4  style="color: black;">Fuel Refilling Report</h4>
<?php
