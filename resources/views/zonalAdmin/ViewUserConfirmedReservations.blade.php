  ...
  <!-- New driver modal -->
    ...
    <table class="table table-striped table-bordered" id="vehicle">
      <thead>
        ...
        <tr>
            <form action="/zonalAdmin/completeReservation/{{$view->id}}" method="POST">
              {{csrf_field()}}
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                ...
                <a href="/zonalAdmin/editReservation/{{$view->id}}" class="btn btn-primary btn-sm view" style="width: 60px;">Edit</a>
