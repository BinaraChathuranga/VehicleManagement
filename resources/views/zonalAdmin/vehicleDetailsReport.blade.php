  ...
  <!-- New driver modal -->
    <section class="content">
        ...
        <div class="alert collapse" role="alert" style="text-align: center; background-color: transparent;" id="alert1">
          <a href="/zonalAdmin/reportsVehicles" class="btn btn-success mb-3" id="back" style="width: 100px;">Back</a>
        </div>
        </div>
      </div>
        ...
        <div class="card">
         <div class="card-body">
          ...
          <form action="/zonalAdmin/filterVehiclesReport" method="POST">
            {{csrf_field()}}
...
<div class="alert alert-light collapse" role="alert" style="text-align: center;" id="alert">
  ...
  <h6 style="color: black;">{{Auth::user()->zone}} | All Vehicle Details<h6>
</div>
