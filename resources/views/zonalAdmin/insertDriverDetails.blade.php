...
<hr>
   ...
   <div class="container-fluid">
    <div class="card">
        <div class="card-body">
          <form action="{{route('zonalAdmin.driverDetails.store')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
       <div class="row">
           <div class="col-12 col-lg-6" >
            ...
            <div class="input-group input-group-sm mb-3">
              ...
              <input type="text" name="NIC" pattern="([0-9]{9}[V]|[0-9]{12})"  title="Please enter valid old or new NIC No."  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
            </div>
            ...
            <div class="input-group input-group-sm mb-3">
              ...
              <input type="text" name="mobile" pattern="[0-9]{10}" title="Please enter Contact number with 10 digits" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
            </div>
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" pattern="[0-9]{10}" title="Please enter Contact number with 10 digits" name="OCNumber" aria-label="Last name" class="form-control">
              </div>
