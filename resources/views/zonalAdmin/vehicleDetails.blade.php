    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-4">
          ...
          <a href="{{route('zonalAdmin.vehicleDetails.create')}}" class="btn btn-primary">New Vehicle</a> 
        </div><!-- /.col -->
      ...
      <thead>
        ...
        <tr>
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                <a href="/zonalAdmin/viewVehicleDetails/{{$vI->regNo}}" class="btn btn-success view" >View</a>
                <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="sr-only">Toggle Dropdown</span>
                </button>
                <div class="dropdown-menu">
                  <a class="dropdown-item " href="/zonalAdmin/editVDetails/{{$vI->regNo}}">Edit</a>
                  <a class="dropdown-item " href="/zonalAdmin/deleteVDetails/{{$vI->regNo}}">Delete</a>
                </div>
              </div>
            </td> 
