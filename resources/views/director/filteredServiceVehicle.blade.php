  ...
  <!-- New driver modal -->
    <section class="content">
        ...
        <div class="card">
         ...
         <form action="/director/filterServiceVehicles" method="POST">
            {{csrf_field()}}
      ...
      <thead>
        ...
        <tr class="table-danger">
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                <a href="/director/viewVehicleParts/{{$vDetails->regNo}}" class="btn btn-danger" style="width: 120px;" >View Parts <span class="badge badge-light">{{$count}}</span></a>
                <a href="/director/viewServiceDetails/{{$vDetails->regNo}}" class="btn btn-secondary" style="width: 140px;" >Service Details</a>
              </div>
            </td>   
        </tr>
        ...
        <tr>
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                <a href="/director/viewVehicleParts/{{$vDetails->regNo}}" class="btn btn-success" style="width: 100px;" >View Parts</a>
                <a href="/director/viewServiceDetails/{{$vDetails->regNo}}" class="btn btn-secondary" style="width: 140px;" >Service Details</a>
              </div>
            </td>   
        </tr>
