  ...
  <!-- New driver modal -->
    <section class="content">
        ...
        <div class="alert collapse" role="alert" style="text-align: center; background-color: transparent;" id="alert1">
          <a href="/director/reportsVehicles" class="btn btn-success mb-3" id="back" style="width: 100px;">Back</a>
        </div>
        </div>
      </div>
        ...
        <div class="card">
         <div class="card-body">
          ...
          <form action="/director/filterVehiclesReport" method="POST">
            {{csrf_field()}}
...
<div class="alert alert-light collapse" role="alert" style="text-align: center;" id="alert">
  ...
  <h6 style="color: black;">Education Department - CP | All Vehicle Details<h6>
</div>
      ...
      <thead>
        ...
        <tr>
            ...
            <td style="text-align:center;">
              <div class="btn-group">
                <a href="/director/viewVehicleDetails/{{$vI->regNo}}" class="btn btn-success view" >View</a>
                </button>
