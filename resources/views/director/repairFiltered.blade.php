    ...
    <section class="content">
        ...
        <div class="card">
         ...
         @if(session('status'))
             ...
             @endif
         <form action="/director/filterRepairsVehicles" method="POST">
            {{csrf_field()}}
      ...
      <thead>
        ...
        <tr class="table">
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                <a href="/director/viewRepairDetails/{{$vDetails->regNo}}" hidden class="btn btn-success" style="width: 120px;" >View </a>
        ...
        <tr class="table">
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                <a href="/director/viewRepairDetails/{{$vDetails->regNo}}" class="btn btn-success" style="width: 120px;" >View </a>
