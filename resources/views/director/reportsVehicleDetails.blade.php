...
@section('content')   
  ...
  <center>
   <div class="btn-group btn-group-toggle" data-toggle="buttons">
    ...
    <a href="/director/vehicleDetails" name="options" id="option1" class="btn btn-dark">Vehicle Report</a>
    <a href="/director/reservationDetails" name="options" id="option1" class="btn btn-dark">Reservation Report</a>

    @if(Illuminate\Support\Facades\DB::table('fuelconsuption')->where('vehicleNo','=',$dvInfo->regNo)->count() > 0)
    <a href="/director/vehFuelConsumption/{{$dvInfo->regNo}}" name="options" id="option1" class="btn btn-dark">Fuel Consumption Report</a>
    <a href="/director/viewRefillDetails/{{$dvInfo->regNo}}" name="options" id="option1" class="btn btn-dark">Fuel Refilled Report</a>
    <a href="/director/runnigChart/{{$dvInfo->regNo}}" name="options" id="option1" class="btn btn-dark">Runing Chart</a>

    @elseif(Illuminate\Support\Facades\DB::table('fuelconsuption')->where('vehicleNo','=',$dvInfo->regNo)->count() == 0)
    <a href="/director/vehFuelConsumption/{{$dvInfo->regNo}}" hidden name="options" id="option1" class="btn btn-dark">Fuel Consumption Report</a>
    <a href="/director/viewRefillDetails/{{$dvInfo->regNo}}" hidden name="options" id="option1" class="btn btn-dark">Fuel Refilled Report</a>
    <a href="/director/runnigChart/{{$dvInfo->regNo}}" hidden name="options" id="option1" class="btn btn-dark">Runing Chart</a>
    @endif

    @if(Illuminate\Support\Facades\DB::table('servicedetails')->where('vehicleNoService','=',$dvInfo->regNo)->count() > 0)
    <a href="/director/viewServiceDetails/{{$dvInfo->regNo}}" name="options" id="option1" class="btn btn-dark">Service Report</a>
    @elseif(Illuminate\Support\Facades\DB::table('servicedetails')->where('vehicleNoService','=',$dvInfo->regNo)->count() == 0)
    <a href="/director/viewServiceDetails/{{$dvInfo->regNo}}" hidden name="options" id="option1" class="btn btn-dark">Service Report</a>
    @endif

    @if(Illuminate\Support\Facades\DB::table('repairDetails')->where('vehicleNoRepair','=',$dvInfo->regNo)->count() > 0)
    <a href="/director/viewRepairDetails/{{$dvInfo->regNo}}" name="options" id="option1" class="btn btn-dark">Repair Report</a>
    @elseif(Illuminate\Support\Facades\DB::table('repairDetails')->where('vehicleNoRepair','=',$dvInfo->regNo)->count() == 0)
    <a href="/director/viewRepairDetails/{{$dvInfo->regNo}}" hidden name="options" id="option1" class="btn btn-dark">Repair Report</a>
    @endif
    </div>
  </center>
  </div>
