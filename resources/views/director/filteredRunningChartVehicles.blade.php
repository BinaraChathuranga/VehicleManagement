...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-4">
          <h1 class="m-0 text-dark">Running Chart </h1> 
        </div><!-- /.col -->
    ...
    <section class="content">
        ...
        <div class="card">
         <div class="card-body">
          ...
          <form action="/director/filterRuningChartVehicles" method="POST">
            {{csrf_field()}}
        ...
        <tr>
            ...
            <td>
              <div class="btn-group-sm">
                <a href="/director/runnigChart/{{$vI->regNo}}" class="btn btn-success" >Running Chart</a>
              </div>
            </td> 
        </tr>
