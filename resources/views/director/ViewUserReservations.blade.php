...
<div class="content-header">
  ...
  <!-- New driver modal -->
    ...
    <thead>
        ...
        <tr>
            <form action="/director/approveReservation/{{$view->id}}" method="POST">
              {{csrf_field()}}
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                ...
                <a href="/director/cancelReservation/{{$view->id}}" class="btn btn-danger btn-sm view" style="width: 80px;">Cancel</a>
