    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="input-group input-group-sm mb-3">
          ...
          <input type="date" class="form-control" name="serviceStart" value="">
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="input-group input-group-sm mb-3">
          ...
          <input class="form-control" name="vehNo" id="veNo" value="">
        ...
        <div class="input-group input-group-sm mb-3">
          ...
          <input class="form-control " name="partName" id="paName" value="">
        </div>
        ...
        <div class="input-group input-group-sm mb-3">
          ...
          <textarea class="form-control" name="serviceDetails" value=""></textarea>
        </div>
        ...
        <div class="input-group input-group-sm mb-3">
          ...
          <input type="date" class="form-control" name="serviceEnd" value="">
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="input-group input-group-sm mb-3" hidden>
            ...
            <input class="form-control" name="vNo" id="vNo" value="">
            <input class="form-control " name="partName" id="partName" value="">
          </div>
          ...
          <div class="input-group input-group-sm mb-3">
            ...
            <input class="form-control fuelBal" name="extendMileage" value="">
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="input-group input-group-sm mb-3" hidden>
            ...
            <input class="form-control" name="partId" id="partId" value="">
          </div>
          ...
          <div class="input-group input-group-sm mb-3">
            ...
            <input class="form-control fuelBal" name="partName" id="pName">
          </div>
          ...
          <div class="input-group input-group-sm mb-3">
            ...
            <input class="form-control fuelBal" name="serviceMileage" id="serviceMileage">
          </div>
          ...
          <div class="input-group input-group-sm mb-3">
            ...
            <input class="form-control fuelBal" name="remindMileage" id="remindMileage">
          </div>
