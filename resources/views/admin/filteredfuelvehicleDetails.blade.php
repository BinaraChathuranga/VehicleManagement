    ...
    <section class="content">
        ...
        <div class="card">
         <div class="card-body">
          ...
          <form action="/admin/filterFuelVehicles" method="POST">
            {{csrf_field()}}
        ...
        <tr>
            ...
            <td>
              <div class="btn-group-sm">
                ...
                <a href="/admin/vehFuelConsumption/{{$vI->regNo}}" class="btn btn-warning" >Consumption</a>
                <a href="/admin/viewRefillDetails/{{$vI->regNo}}" class="btn btn-secondary" >Refill Details</a>
              </div>
            </td> 
        </tr>
        ...
        <tr>
            ...
            <td>
              <div class="btn-group-sm" hidden>
                <a href="#" class="btn btn-success refillB" >Refill</a>
                <a href="/director/vehFuelConsumption/{{$vI->regNo}}" class="btn btn-warning" >Consumption</a>
                <a href="/director/viewRefillDetails/{{$vI->regNo}}" class="btn btn-secondary" >Refill Details</a>
              </div>
            </td> 
        </tr>
        @endif
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="refillForm" method="POST" action="/admin/refillFuel">
          {{csrf_field()}}
