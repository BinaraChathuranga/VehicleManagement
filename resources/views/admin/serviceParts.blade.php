...
<div class="content-header">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="/admin/addServiceDetails" method="POST">
        {{csrf_field()}}
 ...
 <div class="modal fade" id="ServicedDetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="/admin/ServicedDetails" method="POST">
        {{csrf_field()}}
      <div class="modal-header">
  ...
  <div class="modal fade" id="extend" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="/admin/extendMileage" method="POST" id="extendMileage">
          {{csrf_field()}}
        <div class="modal-header">
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="/admin/editPartsDetails" method="POST">
          {{csrf_field()}}
        <div class="modal-header">
