  ...
  <!-- New driver modal -->
    <section class="content">
        ...
        <div class="card">
         ...
         <form action="/admin/filterRepairsVehicles" method="POST">
            {{csrf_field()}}
...
<div class="card">
    ...
    <table class="table table-striped table-bordered" id="vehicle">
      <thead>
        ...
        <tbody>
         ...
         <?php
         $repairVeh=App\repairDetail::where('vehicleNoRepair','=',$vDetails->regNo)->where('repairStatus','=','At Repair')->first();
        ...
        <tr class="table">
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                <a href="/admin/viewRepairDetails/{{$vDetails->regNo}}" hidden class="btn btn-success" style="width: 120px;" >View </a>
        ...
        <tr class="table">
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                <a href="/admin/viewRepairDetails/{{$vDetails->regNo}}" class="btn btn-success" style="width: 120px;" >View </a>
                <a href="#" class="btn btn-primary repair" style="width: 140px;" >Add Repair</a>
              </div>
            </td>   
        </tr>

          @elseif($repairVeh->repairStatus != "At Repair")
        <tr class="table">
        ...
        <tr class="table-danger">
            ...
            <td style="text-align: center;">
              <div class="btn-group">
                <a href="/admin/viewRepairDetails/{{$vDetails->regNo}}" class="btn btn-success" style="width: 120px;" >View </a>
                <a href="/admin/completeRepair/{{$vDetails->regNo}}" class="btn btn-primary" style="width: 160px;" >Complete Repair</a>
              </div>
            </td>   
        </tr>
        @endif
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="/admin/addRepairDetails" method="POST">
        {{csrf_field()}}
