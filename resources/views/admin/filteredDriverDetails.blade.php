  ...
  <!-- Main content -->
    ...
    <section class="content">
        ...
        <div class="alert collapse" role="alert" style="text-align: center; background-color: transparent;" id="alert1">
          <a href="/admin/driverDetailsReport" class="btn btn-success mb-3" id="back" style="width: 100px;">Back</a>
        </div>
        </div>
      </div>
        ...
        <div class="card">
         <div class="card-body">
          ...
          <form action="/admin/filterDriverReport" method="POST">
            {{csrf_field()}}
...
<div class="alert alert-light collapse" role="alert" style="text-align: center;" id="alert">
  ...
  <h6 style="color: black;">zone : {{$zonel}} | All Drivers Details<h6>
</div>
    ...
    <table class="table table-striped table-bordered" id="driver1">
      <thead>
        ...
        <tr>
            ...
            <td>
              <div class="btn-group">
                <a href="/admin/viewDriverDetailsReport/{{$dI->NIC}}" class="btn btn-success" >View</a>       
              </div>
            </td> 
