...
<hr>
   ...
   <div class="container-fluid">
    <div class="card">
        <div class="card-body">
          <form action="/admin/editVehicleDetails/{{$vInfo->regNo}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
       <div class="row">
           ...
           <div class="card card-primary border-primary card-outline mt-4" style="width: 500px; border-width:3px; border-bottom:none; border-top: none; ">
                ...
                <input type="text" hidden value="{{$vInfo->makeAndtype}}" name="m&t" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
                <input type="text" hidden value="{{$vInfo->regNo}}" name="regNo" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
      ...
      <div class="input-group input-group-default mb-3">
        ...
        <input type="text" value="{{$vInfo->batteryVoltage}}" pattern="[0-9]+" title="You cannot enter letters here" name="batteryVolt" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
      </div>
      ...
      <div class="input-group input-group-default mb-3">
          ...
          <input type="text" value="{{$vInfo->batteryAmp}}" pattern="[0-9]+" title="You cannot enter letters here" name="batteryAmp" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
        </div>
