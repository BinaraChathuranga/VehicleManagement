...
<hr>
   ...
   <div class="container-fluid">
    <div class="card">
        <div class="card-body">
          <form action="{{route('admin.vehicleDetails.store')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
       <div class="row">
           <div class="col-12 col-lg-6" >
            ...
            <div class=" input-group input-group-default mb-3">
                ...
                <input type="text" name="regNo" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
              </div>
              ...
              <div class=" input-group input-group-default mb-3">
                ...
                <input type="date" name="regDate" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
              </div>
            ...
            <div class="input-group input-group-default mb-3">
              ...
              <input type="text" name="m&t" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
            </div>
            ...
            <div class="input-group input-group-default mb-3">
                ...
                <input type="text" name="chaNo" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
              </div>
            ...
            <div class="input-group input-group-default mb-3">
              ...
              <input type="text" name="engNo" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
            </div>
            ...
            <div class="input-group input-group-default mb-3">
              ...
              <input type="text" name="horsePower" class="form-control" pattern="[0-9]+" title="You cannot enter letters here" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
            </div>
      ...
      <div class=" input-group input-group-default mb-3">
       ...
       <input type="text" name="tOfBody" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
      </div>          
      ...
      <div class=" input-group input-group-default mb-3">
        ...
        <input type="text" name="passengers" class="form-control" pattern="[0-9]+" title="You cannot enter letters here" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
      </div>
      ...
      <div class=" input-group input-group-default mb-3">
        ...
        <input type="text" name="payLoad" class="form-control" pattern="[0-9]+" title="You cannot enter letters here" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
      </div>
      ...
      <div class="input-group input-group-default mb-3">
        ...
        <input type="text" name="batteryVolt" class="form-control" pattern="[0-9]+" title="You cannot enter letters here" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
      </div>
      ...
      <div class="input-group input-group-default mb-3">
          ...
          <input type="text" name="batteryAmp" class="form-control" pattern="[0-9]+" title="You cannot enter letters here" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
        </div>
      ...
      <div class="input-group input-group-default mb-3">
        ...
        <input type="text" name="capacity" class="form-control" pattern="[0-9]+" title="You cannot enter letters here" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
      </div>
      ...
      <div class="input-group input-group-default mb-3">
        ...
        <input type="text" name="crank" class="form-control" pattern="[0-9]+" title="You cannot enter letters here" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
      </div>
