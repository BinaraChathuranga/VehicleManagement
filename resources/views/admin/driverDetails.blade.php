    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-4">
          ...
          <a href="{{route('admin.driverDetails.create')}}" class="btn btn-primary">New Driver</a> 
        </div><!-- /.col -->
    ...
    <table class="table table-striped table-bordered" id="driverDetails">
      <thead>
        ...
        <tr>
            ...
            <td>
              <div class="btn-group">
                <a href="/admin/viewDriverDetails/{{$dI->NIC}}" class="btn btn-success" >View</a>
                <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="sr-only">Toggle Dropdown</span>
                </button>
                <div class="dropdown-menu">
                  <a class="dropdown-item " href="/admin/editDetails/{{$dI->NIC}}">Edit</a>
                  <a class="dropdown-item " href="/admin/deleteDetails/{{$dI->NIC}}">Delete</a>
                </div>
              </div>
            </td>    
        </tr>
