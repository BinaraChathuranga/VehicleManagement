...
class vehicleController extends Controller
{
    ...
    {
        $vInfo=vehicleDetail::where('zone','=',Auth::user()->zone)->get();
        return view('zonalAdmin.vehicleDetails')->with('vInfo',$vInfo);
    }
    ...
    public function viewVehicleDetails($regNo)
    {
        ...
        return view('zonalAdmin.viewVehicleDetails')->with('vInfo',$vInfo);
    ...
    public function editVDetails($regNo)
    {
       ...
       $vInfo=vehicleDetail::where('regNo','=',$regNo)->first();
        return view('zonalAdmin.editVehicleDetails')->with('vInfo',$vInfo);
    ...
    public function editVehicleDetails(Request $request, $regNo)
    {
        ...
        $vehicleInfo->save();
        return redirect()->route('zonalAdmin.vehicleDetails.index')->with('status',"Edited Succesfully!");
    }
    ...
    {
        return view('zonalAdmin.insertVehicleDetails');
    }
    ...
    return redirect()->route('zonalAdmin.vehicleDetails.index')->with('status',"Inserted Succesfully!");
    }
