...
class driverController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.driverDetails')->with('dInfo',$dInfo);
    }
    ...
    public function viewDriverDetails($NIC)
    {
        ...
        return view('admin.viewDriverDetails')->with('dInfo',$dInfo);
    ...
    public function editDetails($NIC)
    {
       ...
       $dInfo=driverDetail::where('NIC','=',$NIC)->first();
        return view('admin.editDriverDetails')->with('dInfo',$dInfo);
    ...
    public function deleteDetails($NIC)
    {
       ...
       $dInfo=driverDetail::where('NIC','=',$NIC)->first();
       $dInfo->delete();
       return redirect()->route('admin.driverDetails.index')->with('status',"Deleted Succesfully!");
    ...
    public function editDriverDetails(Request $request, $NIC)
    {
      ...
      $rec5->workTo=$request->input('workTo4');
        ...
        return redirect()->route('admin.driverDetails.index')->with('status',"Edited Succesfully!");
    }
    ...
    {
       return view('admin.insertDriverDetails');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.driverDetails.index')->with('status',"Inserted Succesfully!");
    }
